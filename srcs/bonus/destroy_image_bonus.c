...
void	ft_dskull_sprites(t_conf *conf, int (*f)(void *, void *))
{
	f(conf->mlx, conf->skull.right[0]);
	f(conf->mlx, conf->skull.right[1]);
	f(conf->mlx, conf->skull.right[2]);
	f(conf->mlx, conf->skull.right[3]);
	f(conf->mlx, conf->skull.right[4]);
	f(conf->mlx, conf->skull.right[5]);
	f(conf->mlx, conf->skull.left[0]);
	f(conf->mlx, conf->skull.left[1]);
	f(conf->mlx, conf->skull.left[2]);
	f(conf->mlx, conf->skull.left[3]);
	f(conf->mlx, conf->skull.left[4]);
	f(conf->mlx, conf->skull.left[5]);
	f(conf->mlx, conf->skull.death[0]);
	f(conf->mlx, conf->skull.death[1]);
	f(conf->mlx, conf->skull.death[2]);
	f(conf->mlx, conf->skull.death[3]);
	f(conf->mlx, conf->skull.death[4]);
	f(conf->mlx, conf->skull.rdth[0]);
	f(conf->mlx, conf->skull.rdth[1]);
	f(conf->mlx, conf->skull.rdth[2]);
	f(conf->mlx, conf->skull.rdth[3]);
	f(conf->mlx, conf->skull.rdth[4]);
	f(conf->mlx, conf->skull.rwait[3]);
	f(conf->mlx, conf->skull.rwait[4]);
	f(conf->mlx, conf->skull.rwait[5]);
}

void	ft_dskull_sprites2(t_conf *conf, int (*f)(void *, void *))
{
	f(conf->mlx, conf->skull.wait[0]);
	f(conf->mlx, conf->skull.wait[1]);
	f(conf->mlx, conf->skull.wait[2]);
	f(conf->mlx, conf->skull.wait[3]);
	f(conf->mlx, conf->skull.wait[4]);
	f(conf->mlx, conf->skull.wait[5]);
	f(conf->mlx, conf->skull.rwait[0]);
	f(conf->mlx, conf->skull.rwait[1]);
	f(conf->mlx, conf->skull.rwait[2]);
}
